/*
JForm that allows the Doctor to select the available time slots using dynamic scroll adjustments
*/
import java.sql.*;
public class Doctor_Slot_Selection extends javax.swing.JFrame {

    /**
     * Creates new form Doctor_Slot_Selection
     */
    public Doctor_Slot_Selection() {
        initComponents();
        this.setSize(500, 650);
        
    }
    public Doctor_Slot_Selection(String a) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Doctor Slot Selection");
        ...
        jToggleButton1.setText("Confirm Slot");
        ...
        jLabel13.setText("Enter Cost per Slot ");
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        try {
            ...
            myStmt.executeUpdate("INSERT INTO `doctorslot1`(name,dep,month,day,start,end,cost) VALUE ('"+name+"','"+dep+"','"+month+"','"+Day+"','"+start+"','"+end+"','"+cost+"')");
            // 4. Process the result set
            //while (myRs.next()) {
                //System.out.println(myRs.getString("DocName") + ", " + myRs.getString("Department"));
            //}
            slot_confirmation frame = new slot_confirmation(name);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Doctor_Slot_Selection.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Doctor_Slot_Selection().setVisible(true);
            }
        });
    }
